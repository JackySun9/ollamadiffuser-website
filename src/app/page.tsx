  ...
  const features = [
    {
      ...
      title: "CLI Interface",
      description: "Ollama-like command-line interface for easy model management"
    },
    {
      icon: <Globe className="h-6 w-6" />,
      title: "Web UI",
      description: "Beautiful web interface with real-time status and image preview"
    },
    {
      icon: <Zap className="h-6 w-6" />,
      title: "LoRA Support",
      description: "Load and manage LoRAs for style modifications and faster generation"
    },
    {
      icon: <Settings className="h-6 w-6" />,
      title: "Model Management",
      description: "Easy download, load, and switch between different AI models"
    },
    {
      icon: <Palette className="h-6 w-6" />,
      title: "Multiple Models",
      description: "Support for FLUX.1, Stable Diffusion 3.5, and more"
    },
    {
      icon: <Code className="h-6 w-6" />,
      title: "REST API",
      description: "Complete API for integration with other applications"
    }
  ]
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-slate-900 to-slate-600 dark:from-slate-100 dark:to-slate-400 bg-clip-text text-transparent">
              Ollama-like Image Generation
            </h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
              Simplify local deployment and management of various image generation models 
              (Stable Diffusion and variants). An intuitive tool inspired by Ollama&apos;s simplicity.
            </p>
      ...
      <section className="py-16 bg-white/50 dark:bg-slate-900/50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-12">
              <h3 className="text-3xl font-bold mb-4">See OllamaDiffuser in Action</h3>
              <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                Watch how easy it is to set up and use OllamaDiffuser for local AI image generation
              </p>
            </div>
